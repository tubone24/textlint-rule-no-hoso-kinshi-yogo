...
var dictionaryUrl = 'https://raw.githubusercontent.com/tubone24/textlint-rule-no-hoso-kinshi-yogo/master/housouKinshiYougo.xml';
var referenceUrl = 'http://monoroch.net/kinshi/';
var dictionaryPath = "".concat(_os.default.tmpdir(), "/housouKinshiYougo.xml");
var maxAge = 604800;

var fetchAndCacheDictionary = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(function* () {
    try {
      var response = yield fetch(dictionaryUrl);
  ...
  return function fetchAndCacheDictionary() {
    return _ref.apply(this, arguments);
  };
}();

var readDictionaryFromCache = (_ref2) => {
  var {
    ignoreMaxAge = false
  } = _ref2;
...
var getDictionary = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(function* () {
    var text = readDictionaryFromCache({}) || (yield fetchAndCacheDictionary()) || readDictionaryFromCache({
      ignoreMaxAge: true
    });
    ...
    [Syntax.Str](node) {
      return _asyncToGenerator(function* () {
        ...
        tokens.forEach((_ref4) => {
          ...
          housouKinshiYougoList === null || housouKinshiYougoList === void 0 ? void 0 : (_housouKinshiYougoLis = housouKinshiYougoList.dirtyWord) === null || _housouKinshiYougoLis === void 0 ? void 0 : _housouKinshiYougoLis.forEach((_ref5) => {
            var {
              notes,
              replaceWordList,
              word
